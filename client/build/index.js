...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("C:\\Users\\vlad\\Desktop\\CustomersListReact\\node_modules\\react-hot-loader\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("C:\\Users\\vlad\\Desktop\\CustomersListReact\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _customers = __webpack_require__(159);

	var _customers2 = _interopRequireDefault(_customers);

	_reactDom2["default"].render(_react2["default"].createElement(_customers2["default"], null), document.getElementById('container'));

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\Users\\vlad\\Desktop\\CustomersListReact\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports["default"] = _react2["default"].createClass({
	    ...
	    renderCustomers: function renderCustomers() {
	        var _this = this;

	        return this.state.customers.map(function (item, index) {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "td",
	                    null,
	                    _react2["default"].createElement("button", { className: "fa fa-trash-o btn btn-danger", value: index,
	                        onClick: _this.removeCustomer })
	                ),
	                _react2["default"].createElement(
	                    "td",
	                    null,
	    ...
	    createCustomer: function createCustomer(e) {
	        ...
	        for (var i = 0; i < keys.length; i++) {
	            customerData[keys[i]] = _reactDom2["default"].findDOMNode(this.refs[keys[i]]).value;
	            _reactDom2["default"].findDOMNode(this.refs[keys[i]]).value = '';
	        }
	    ...
	    sortCustomers: function sortCustomers(e) {
	        e.preventDefault();
	        var target = '',
	            sortCustomers = undefined,
	            data = {};
	        ...
	        if (this.state.sortByAscending[target]) {
	            data[target] = false;
	            sortCustomers = this.state.customers.sort(function (a, b) {
	    ...
	    render: function render() {
	        return _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	                "form",
	                { className: "form-horizontal", onSubmit: this.createCustomer },
	                _react2["default"].createElement(
	                    "div",
	                    { className: "form-group" },
	                    _react2["default"].createElement(
	                        "label",
	                        { "for": "first_name", className: "col-sm-3 control-label" },
	                        "First Name"
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "col-sm-9" },
	                        _react2["default"].createElement("input", { id: "first_name", className: "form-control", type: "text", ref: "firstName",
	                            placeholder: "e.g. Stevie", required: true, pattern: "[a-zA-Z]+" })
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    ...
	                    _react2["default"].createElement(
	                        "label",
	                        { "for": "second_name", className: "col-sm-3 control-label" },
	                        "Second Name"
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "col-sm-9" },
	                        _react2["default"].createElement("input", { id: "second_name", className: "form-control", type: "text", ref: "lastName",
	                            placeholder: "e.g. Wonder", required: true, pattern: "[a-zA-Z]+" })
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    ...
	                    _react2["default"].createElement(
	                        "label",
	                        { "for": "phone", className: "col-sm-3 control-label" },
	                        "Phone"
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "col-sm-9" },
	                        _react2["default"].createElement("input", { id: "phone", className: "form-control", type: "tel", ref: "phone",
	                            placeholder: "Must contain 10 digits (e.g. 0981234567)", required: true, pattern: "[0-9]{10}" })
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    ...
	                    _react2["default"].createElement(
	                        "label",
	                        { "for": "gender", className: "col-sm-3 control-label" },
	                        "Gender"
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        ...
	                        _react2["default"].createElement(
	                            "select",
	                            { id: "gender", className: "form-control", ref: "gender" },
	                            _react2["default"].createElement(
	                                "option",
	                                { value: "male" },
	                                "male"
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "label",
	                        { "for": "age", className: "col-sm-3 control-label" },
	                        "Age"
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "col-sm-9" },
	                        _react2["default"].createElement("input", { id: "age", className: "form-control", type: "text", ref: "age",
	                            placeholder: "Must contain 2 digits", required: true, pattern: "[0-9]{2}" })
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    { className: "form-group submit-btn" },
	                    _react2["default"].createElement("input", { className: "btn btn-success", type: "submit", value: "New customer" })
	                )
	            ),
	            _react2["default"].createElement(
	                "table",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            "Name ",
	                            _react2["default"].createElement("i", { className: this.state.sortByAscending.firstName ? "fa fa-caret-up" : "fa fa-caret-down" })
	                        ),
	                        _react2["default"].createElement(
	                            "td",
	                            { onClick: this.sortCustomers },
	                            "Surname ",
	                            _react2["default"].createElement("i", { className: this.state.sortByAscending.lastName ? "fa fa-caret-up" : "fa fa-caret-down" })
	                        ),
	                        _react2["default"].createElement(
	                            "td",
	                            { onClick: this.sortCustomers },
	                            "Phone ",
	                            _react2["default"].createElement("i", { className: this.state.sortByAscending.phone ? "fa fa-caret-up" : "fa fa-caret-down" })
	                        ),
	                        _react2["default"].createElement(
	                            "td",
	                            { onClick: this.sortCustomers },
	                            "Gender ",
	                            _react2["default"].createElement("i", { className: this.state.sortByAscending.gender ? "fa fa-caret-up" : "fa fa-caret-down" })
	                        ),
	                        _react2["default"].createElement(
	                            "td",
	                            { onClick: this.sortCustomers },
	                            "Age ",
	                            _react2["default"].createElement("i", { className: this.state.sortByAscending.age ? "fa fa-caret-up" : "fa fa-caret-down" })
	                        )
	                    )
	                ),
	                _react2["default"].createElement(
